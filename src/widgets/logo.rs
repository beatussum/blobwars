...
mod tests {
    ...
    fn render() {
        ...
        Logo.render(area, &mut tested);

        let expected = [
            r##"     ...     ..             ..                   ..                                 "##,
            r##"  .=*8888x <"?88h.    x .d88"              . uW8"                                   "##,
            r##" X>  '8888H> '8888     5888R          u.   `t888                                    "##,
            r##"'88h. `8888   8888     '888R    ...ue888b   8888   .                                "##,
            r##"'8888 '8888    "88>     888R    888R Y888r  9888.z88N                               "##,
            r##" `888 '8888.xH888x.     888R    888R I888>  9888  888E                              "##,
            r##"   X" :88*~  `*8888>    888R    888R I888>  9888  888E                              "##,
            r##" ~"   !"`      "888>    888R    888R I888>  9888  888E                              "##,
            r##"  .H8888h.      ?88     888R   u8888cJ888   9888  888E                              "##,
            r##" :"^"88888h.    '!     .888B .  "*888*P"   .8888  888"                              "##,
            r##" ^    "88888hx.+"      ^*888%     'Y"       `%888*%"                                "##,
            r##"        ^"**""           "%                    "`                                   "##,
            r##"                         ...    .     ...                                   .x+=:.  "##,
            r##"                      .~`"888x.!**h.-``888h.                               z`    ^% "##,
            r##"                     dX   `8888   :X   48888>                  .u    .        .   <k"##,
            r##"                    '888x  8888  X88.  '8888>         u      .d88B :@8c     .@8Ned8""##,
            r##"                    '88888 8888X:8888:   )?""`     us888u.  ="8888f8888r  .@^%8888" "##,
            r##"                     `8888>8888 '88888>.88h.    .@88 "8888"   4888>'88"  x88:  `)8b."##,
            r##"                       `8" 888f  `8888>X88888.  9888  9888    4888> '    8888N=*8888"##,
            r##"                      -~` '8%"     88" `88888X  9888  9888    4888>       %8"    R88"##,
            r##"                      .H888n.      XHn.  `*88!  9888  9888   .d888L .+     @8Wou 9% "##,
            r##"                     :88888888x..x88888X.  `!   9888  9888   ^"8888*"    .888888P`  "##,
            r##"                     f  ^%888888% `*88888nx"    "888*""888"     "Y"      `   ^"F    "##,
            r##"                          `"**"`    `"**""       ^Y"   ^Y'                          "##,
        ];
        ...
        expected.set_style(
            Rect::new(0, 0, Logo::B_WIDTH, Logo::HEIGHT as _),
            Logo::CAPITAL_STYLE,
        );

        expected.set_style(
            Rect::new(
                Logo::B_WIDTH + Logo::OFFSET_WIDTH,
                0,
                Logo::LOB_WIDTH,
                Logo::HEIGHT as _,
            ),
        ...
        expected.set_style(
            Rect::new(
                Logo::MARGIN_WIDTH + Logo::W_WIDTH + Logo::OFFSET_WIDTH,
                Logo::HEIGHT as _,
                Logo::ARS_WIDTH,
                Logo::HEIGHT as _,
            ),
